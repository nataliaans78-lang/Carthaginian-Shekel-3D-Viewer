...
export const COPY: Record<Language, CopyShape> = {
  en: {
    ...
    presetHint: "1 = museum · 2 = gallery · R = reset · A = auto-rotate",
  ...
  pl: {
    ...
    presetHint: "1 = muzeum · 2 = galeria · R = reset · A = autoobrót",
  ...
  fr: {
    ...
    presetHint: "1 = musée · 2 = galerie · R = réinitialiser · A = rotation auto",
